...
var _baseUrl, _clientId, _clientSecret, _customFetch, _getConfiguration, _baseUrl2, _clientId2, _customFetch2, _grantRequest, _Class9_brand, _entries, _ttlMs, _maxEntries, _configuration, _serverMetadata, _clientAuthPromise, _options, _customFetch3, _jwks, _discoveryCache, _inFlightDiscovery, _jwksCache, _Class1_brand;
...
function getTelemetryConfig(config) {
    ...
    return {
        ...
        version: (_config$version = config === null || config === void 0 ? void 0 : config.version) !== null && _config$version !== void 0 ? _config$version : "1.9.1"
    };
}
...
class AuthClient {
    constructor(_options2) {
        ...
        this.mfa = new MfaClient({
            ...
            getConfiguration: async () => (await _assertClassBrand(_Class1_brand, this, _discover).call(this)).configuration
        });
        this.passkey = new PasskeyClient({
            ...
            grantRequest: async (grantType, params) => {
                const _await$_assertClassBr = await _assertClassBrand(_Class1_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr.serverMetadata;
                const configuration = await _assertClassBrand(_Class1_brand, this, _createConfiguration).call(this, serverMetadata);
                configuration[customFetch$1] = createPasskeyFetch(_classPrivateFieldGet2(_customFetch3, this), grantType);
